    ...
    <div id='About' className={style.container}>
      ...
      <div className={style.bloque1}>
        <div className={style.subBloque1}>
          ...
          <div className={style.softTitle}>Soft Skills</div>
        ...
        <div className={style.subBloque2}>
          <div className={style.softTitle}>Tech Skills</div>
      ...
      <div className={style.bloque2}>
        <div>
          <img className={style.huevo} src={token} alt="token image" />
        </div>
        <div className={style.text1}>who I am ?</div>
        <div className={style.text2}>I'm a Full Stack Developer from Buenos Aires, Argentina.<br/>
